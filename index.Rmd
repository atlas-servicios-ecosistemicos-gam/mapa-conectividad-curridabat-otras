---
title: "Mapa de conectividad de grupos funcionales de aves en otros hábitats en el cantón de Curridabat"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/conectividad/curridabat/otras/PROBABILIDAD_CONECTIVIDAD_OTRAS_CURRIDABAT_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_parches_esenciales_importantes_otras_curridabat/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_rutas_conectividad_otras_curridabat/FeatureServer/0"
...
# Esencialidad
bins_esencialidad <- c(0, 0.0011697, 0.0005781, Inf)
etiquetas_esencialidad <- c("Poco esencial", "Medianamente esencial", "Muy esencial")
pal_esencialidad <- 
  colorBin(
...
# Importancia
bins_importancia <- c(0, 40000000.00, 60000000.00, 80000000.00, 100000000.00, Inf)
